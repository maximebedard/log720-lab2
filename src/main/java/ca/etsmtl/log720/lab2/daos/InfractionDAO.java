...
public class InfractionDAO {
    ...
    private final String ALL_FOR_DOSSIER = "SELECT id, description, gravite FROM infractions INNER JOIN infraction_dossiers ON (id = infraction_id) WHERE dossier_id = ?";
    ...
    public List<Infraction> allForDossier(Dossier dossier) {
        ...
        try {
            PreparedStatement statement = connection.prepareStatement(ALL_FOR_DOSSIER);
